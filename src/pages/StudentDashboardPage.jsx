...
import { BarChart3, ClipboardList, MessageSquareText, UserRound } from 'lucide-react'
        ...
        >
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-300">
              ...
              the student account linked to {student?.email}.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="mt-1 text-2xl font-semibold text-white">No results yet</h3>
              </div>
            </div>
            <p className="mt-4 text-sm leading-7 text-slate-300">
              No exam data is available right now. Once tests are added later,
              marks and percentage will appear here.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="mt-1 text-2xl font-semibold text-white">No feedback available</h3>
              </div>
            </div>
            <p className="mt-4 text-sm leading-7 text-slate-300">
